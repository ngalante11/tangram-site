# Tangram — Content Calendar (4-Week Rolling)

**Cadence:** 2 blog/wk · 4–5 social/wk · email fires event-triggered + 1 broadcast/wk.
**Theme:** Back-to-school. All roads → free trial.
**Pillars:** ①One-build ②Methodology ③Observation-ready ④Knows-your-students.

Status key: `draft` = written, in repo · `queued` = scheduled in tool · `live` = published.

---

## WEEK 1 — "The Sunday Night Problem" (activation)
...
## WEEK 2 — "A Real Method" (trust + moat)
...
| Day | Channel | Asset | Pillar | Status |
|---|---|---|---|---|
| Mon | Blog | *One Lesson, Five Classes: A Walkthrough of How Tangram Adapts* | ① ④ | plan |
| Mon | IG/TikTok | Full workflow demo (start → 5 versions) | ① | plan |
| Tue | Email | Trial-conversion #3 (last call + Founding Member) | — | plan |
| Wed | IG/TikTok | FAQ / objection-buster carousel ("but does it actually save time?") | ② | plan |
| Thu | Blog | *Marzano vs. Danielson vs. UbD: Plan Once for Whichever Your School Uses* | ③ | plan |
| Fri | Recap | Measure week, log trial starts, refill calendar for week 5 | — | — |

---

## Repurposing rule (get 5 assets from 1)

Every blog post becomes: 1 IG carousel + 1 TikTok hook + 1 FB-group value post +
1 Pinterest pin + 1 email section. Write once, atomize everywhere.

## Backlog / ideas parking lot

- "New teacher survival: your first observation" (targets new-teacher segment later)
- District/B2B one-pager (when we pivot to B2B goal)
- Seasonal: "Sub plans that don't fall apart" · "Report card comment season"
- Lead magnet: "The Mixed-Ability Lesson Checklist" (email capture)
